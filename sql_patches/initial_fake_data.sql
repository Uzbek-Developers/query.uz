...
insert into tag(id, name, owner_id) values(4, 'spring',1);
insert into tag(id, name, owner_id) values(5, 'hibernate',1);
insert into tag(id, name, owner_id) values(6, 'angular-js',1);



insert into question(id, title, content, owner_id) values(1, 'Test Question 1', 'Lorem ipsum dolor...', 1);
insert into question(id, title, content, owner_id) values(2, 'Test Question 2', 'Lorem ipsum dolor...', 1);
insert into question(id, title, content, owner_id) values(3, 'Test Question 3', 'Lorem ipsum dolor...', 1);
insert into question(id, title, content, owner_id) values(4, 'Test Question 4', 'Lorem ipsum dolor...', 1);
...
insert into answer(id, content,  owner_id) values(1, "ans",  1, 1);
insert into answer(id, content, owner_id) values(2, "ans",  1, 2);
insert into answer(id, content, owner_id) values(3, "ans",  1, 3);
